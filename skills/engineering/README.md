...
- **[teach-pr](./teach-pr/SKILL.md)** — Turn a GitHub PR into an adaptive quiz (MCQ, open questions, code writing), tracking per-concept progress in your Obsidian vault across sessions.
